...
var TestController = /** @class */ (function (_super) {
    ...
    TestController.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.json('teste1')];
            });
        });
    };
    TestController.prototype.test = function (start) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.httpContext.response.send(start)];
            });
        });
    };
    __decorate([
    ...
    __decorate([
        inversify_express_utils_1.httpGet('/url2'),
        __param(0, inversify_express_utils_1.queryParam('start')),
        __metadata("design:type", Function),
